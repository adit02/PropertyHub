<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.master" AutoEventWireup="true" CodeFile="EditBuilder.aspx.cs" Inherits="Builder_EditBuilder" %>

<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    <asp:MultiView ID="multiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="viewBuilderUpdate" runat="server">
                <asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>

                <div class="boxed" id="login">
                    <div class="title">
                        <asp:Label ID="Label1" runat="server" Text="Update Builder Details"></asp:Label>
                    </div>
                    <div class="content">
                        <div class="subtitle">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:Button ID="btnSubmit" runat="server" Text="Update" CssClass="inputsubmit" 
        ...
        <asp:View ID="viewBuilderUpdated" runat="server">
            <div class="boxed">
                <div class="title">
