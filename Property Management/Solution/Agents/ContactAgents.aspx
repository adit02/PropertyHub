<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.master" AutoEventWireup="true" CodeFile="ContactAgents.aspx.cs" Inherits="Agents_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    ...
    <div class="boxed">    
        <div class="title">
            <asp:Label ID="Label1" runat="server" Text="Agent Information"></asp:Label>
        </div>
        <div class="content">
