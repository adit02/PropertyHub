<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Home.master" AutoEventWireup="true" CodeFile="EditAgent.aspx.cs" Inherits="Agents_EditAgent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="main" Runat="Server">
    ...
    <asp:MultiView ID="multiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="viewAgentUpdate" runat="server">
                <div class="boxed" id="login">
                    <div class="title">
                        <asp:Label ID="Label1" runat="server" Text="Edit Agent Details"></asp:Label>
                    </div>
                    <div class="content">
                        <div class="subtitle">
                            <asp:Label ID="Label2" runat="server" Text="About Your Company"></asp:Label>
                        </div>
                    <asp:Label ID="Label3" runat="server" Text="Agent Name*" Width="140px"></asp:Label>
                    <asp:TextBox ID="txtAgentName" runat="server" CssClass="inputtext"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ErrorMessage="Agent Name cann't be Empty" ControlToValidate="txtAgentName" 
                    ...
                    Text="About Your Business*"></asp:Label>
                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" 
                    CssClass="inputtext" width="400px"></asp:TextBox><br />
                    <asp:Label ID="Label15" runat="server" Text="Authorised Agents*" Width="140px" 
                            style="vertical-align:top"></asp:Label>
                    <asp:TextBox ID="txtAuthorisedAgents" runat="server" TextMode="MultiLine" 
        ...
        <asp:View ID="viewAgentUpdated" runat="server">
            <div class="boxed">
                <div class="title">
