...
public partial class Agents_Default : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "INSERT INTO Agents " +
                            "(Userid,AgentName,CompanyName,CompanyLogo,OperatingSince,Title,TransactionType,PropertyType,ShortDescription,LongDescription,AuthorisedAgents,City,Locality)" +
                            "VALUES (@userid,@agentname,@companyname,@companylogo,@operatingsince,@title,@transactiontypes,@propertytypes,@shortdescription,@longdescription,@authorisedagents,@city,@locality)";
