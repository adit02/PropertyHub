...
public partial class Property_EditProperty : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "Update Property " +
                        "set postedfor=@postedfor,propertytype=@propertytype,propertysubtype=@propertysubtype,txntype=@txntype,city=@city,locality=@locality,bedrooms=@bedrooms,bathrooms=@bathrooms,furnished=@furnished,coveredarea=@coveredarea,plotlandarea=@plotlandarea,carpetarea=@carpetarea,totalprice=@totalprice,floorno=@floorno, totalfloors=@totalfloors, description=@description,possessionstatus=@possessionstatus " +
                        "where userid=@userid";
        ...
        if (result > 0)
        {
            multiView.SetActiveView(viewPropertyUpdated);
        }
        #endregion
    }
